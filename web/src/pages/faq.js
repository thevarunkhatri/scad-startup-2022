          ...
          <Container>
            ...
            <div class="faqContainer">
              <div class="faqCard" id="content1">
                ...
                <p>Short answer, yes! But there are some rules. All presenters must be on ground. If you are from the Atlanta, Lacoste, or E-learning campuses, you have two options:<br></br><br></br>
                1. Travel to Savannah to present in person (and participate in some awesome activities)! <br></br> 
                2. Have a student from the Savannah campus on your team so they can present the project (you will still be recognized for your participation and potential winnings).</p>
              </div>

              <div class="faqCard" id="content2">
